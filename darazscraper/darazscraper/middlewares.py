...
# Middleware for Creating fake Browser Headers through API
class ScrapeOpsFakeBrowserHeaderAgentMiddleware:
    ...
    # Getting a list of fake Headers from API
    ...
    # Selecting random Header during each request
    def _get_random_browser_header(self):
        random_index = randint(0, len(self.headers_list) - 1)
        return self.headers_list[random_index]

    # Enable fake browser header if it is disabled
    ...
    # This is the function our crawler will look for during invoking middleware
    def process_request(self, request, spider):
